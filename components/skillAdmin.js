...
const SkillAdmin = ({deleteFn, editSkillFn}) => {
    return(
        <div className={styles.skillAdmContainer}>
            ...
            <div className={styles.skillButtons}>
                <button onClick={() => editSkillFn(true)} className={styles.skillEdit}>Skill</button>
                <button onClick={() => deleteFn(true)} className={styles.skillDelete}>Delete</button>
            </div>
        </div>
    );
};
